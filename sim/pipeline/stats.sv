module stats(
    ...
    always_comb begin
        ...
        if (pipeline_inst.wb_stage_inst.excep)
            for (int i = 0; i < 4; i++) if (~cmt[i])
                begin cmt[i] = 1; cmt_gpr[i] = 0; cmt_mem[i] = 0; break; end
